...
<head>
    ...
    <script>
			function Update(){
	          ...
	          xmlhttp.open("POST","updating.php",true);
         ...
         function Search(){
	      ...
	      xmlhttp.onreadystatechange=function(){
	        if (this.readyState == 4 && this.status == 200){
				...
				{
					document.getElementById("e_nm").value="";
					document.getElementById("emp_type").value="";
					window.alert("Id does not exist.");
				}
	            var myArr=JSON.parse(this.responseText);
				document.getElementById("e_nm").value=myArr['e_name'];
				document.getElementById("emp_type").value=myArr['e_type'];
			}
	          };
	          xmlhttp.open("GET","search.php?e_id="+id,true);
	          xmlhttp.send();
			  }
    </script>
</head>
...
$eid = $_SESSION['eid'];/*DEBORUPA INSERT EMPLOYEE ID HERE*/	
...
<div class="w3-top">
	<div class="w3-bar w3-theme-d2 w3-left-align w3-large">
		...
		<a href="admin_insert_employee.php" class="w3-bar-item w3-button w3-padding-large ">Add Employee</a>
		<a href="admin_update_employee.php" class="w3-bar-item w3-button w3-padding-large w3-theme-d4">Update Employee</a>
...
<div class="w3-container w3-content" style="max-width:1400px;margin-top:80px">
    <center>
			<br>
			<h4><i>UPDATE EMPLOYEE DETAILS</i></h4> 
			<hr>
			<br>
			<form>
			EMPLOYEE ID: <input type="text" name="e_id" id="e_id" > <button type="button" style="margin-left:20px" onclick="Search();">Search</button><br><br><br><br><br>
			EMPLOYEE NAME: <input type="text" name="e_nm" id="e_nm" ><br><br>
