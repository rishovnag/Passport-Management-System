...
<div class="w3-container w3-content" style="max-width:1400px;margin-top:80px">
	<div class="w3-container w3-card w3-white w3-round w3-margin">
		...
		<p>
			...
			<button onclick="showStatus()">Submit</button>
		</p>
	</div>
	<div class="w3-container w3-card w3-white w3-round w3-margin" id="txtHintStatus">
		<p>Application Status will be shown here</p>
	</div>
</div>
<!-- Footer -->
...
function showStatus() {
	var str = document.getElementById("appId").value;
    if (str == "") {
        document.getElementById("txtHintStatus").innerHTML = "<p>Application Status will be shown here</p>";
        return;
    } else { 
